    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(options => {
                options.UseSqlServer(Configuration.GetConnectionString("ScoutsArduContext"));
            });
            ...
            services.AddOpenApiDocument(c =>
            {
                ...
                c.Title = "ScoutsArduAPI";
                c.Version = "v1";
                c.Description = "The Scouts Ardu API documentation description.";
